...
from ansible.module_utils.network.a10.a10 import run_commands
from ansible.module_utils.network.a10.a10 import get_capabilities
...
class Hardware(FactsBase):
    ...
    def parse_memory(self, data):
        # Memory 8071 Mbyte, Free Memory 3816 Mbyte
        data = data.strip()
        mem_list = data.split(',')
    ...
    def populate(self):
        ...
        self.facts['memtotal_mb'] = self.parse_memory(memory_info)[0]
        self.facts['memfree_mb'] = self.parse_memory(memory_info)[1]
...
class Interfaces(FactsBase):
    ...
    def populate(self):
        ...
        data = responses[0].strip()
        data = responses[0].split('\n\n  ')
