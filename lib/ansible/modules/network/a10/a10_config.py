...
short_description: Manage A10 ACOS configuration sections
description:
  - A10 ACOS configurations use a simple block indent file syntax
    for segmenting configuration into sections.  This module provides
    an implementation for working with ACOS configuration sections in
    a deterministic way.
notes:
...
- name: simple loadbalancer create commands
  a10_config:
    lines:
      ...
      - slb template http adi-http-test
      ...
      - member rs1-test 80
      - member rs2-test 80
      - slb virtual-server vip1test1 2.2.2.3
      - port 80 http
...
backup_path:
  ...
  type: str
  sample: /playbooks/ansible/backup/a10_config.2016-07-16@22:28:34
filename:
...
from ansible.module_utils.network.a10.a10 import get_config, run_commands
from ansible.module_utils.network.a10.a10 import get_defaults_flag
from ansible.module_utils.network.a10.a10 import backup, get_connection
...
def main():
    ...
    startup_config_list = configuration_to_list(startup_configuration)
